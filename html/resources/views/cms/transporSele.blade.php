...
<div class="container">
  ...
  <div class="accordion" id="accordionExample">
    <div class="accordion-item">
      ...
      <div id="panelsStayOpen-collapseOne" class="panelsStayOpen-collapseOne collapse show" aria-labelledby="panelsStayOpen-headingOne" data-bs-parent="#accordionExample">
          ...
          @else
            <div class="btn-group">
              ...
              @foreach($dataList as $k=>$v)
                  <li><a class="dropdown-item" href="{{url('cityBusSele/'.$v->id)}}" {{$cityCode==$v->id?'active':''}}>{{$v->name}}</a></li>
              @endforeach
              </ul>
            </div>
          @endif
          @if($BusD==null&&$cityCode!=null)
              ...
              @foreach ($BusD as $v)
                {{-- <div class="card-body" style="background:rgb(186 186 186 / 21%);margin-bottom:1vh;"> --}}
                  <div class="row align-items-center" style="background:rgb(186 186 186 / 21%);margin-bottom:1vh;margin-top:2vh;padding:1.5vh;">
                    <div class="col-7 align-items-center" style="font-size:2vh;">
                      {{$v->nameZh}}
                    </div>
                    <div class="col-3 align-items-center" style="display:flex;">
                      @if($v->BusLineEnable==1)
                        <svg xmlns="http://www.w3.org/2000/svg" style="color:rgb(0, 226, 0);width:3vh;" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
                      ...
                      @if($v->BusLineEnable==0)
                        <svg xmlns="http://www.w3.org/2000/svg" style="color:rgb(255, 0, 0);width:3vh;" fill="currentColor" class="bi bi-dash-circle" viewBox="0 0 16 16">
                    ...
                    <div class="col-2 align-items-center" style="display:flex;">
                      <svg xmlns="http://www.w3.org/2000/svg" style="color:rgb(255 128 0);width:3vh;" fill="currentColor" class="bi bi-arrow-repeat" viewBox="0 0 16 16">
